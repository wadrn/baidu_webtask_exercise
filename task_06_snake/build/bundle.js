...
/******/ 	var hotCurrentHash = "6bad835c093fd8808805"; // eslint-disable-line no-unused-vars
...
function createMap(row, col) {
    ...
    //     tr.appendTo($('#tbody'));
    // }
    var tr = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("<tr></tr>");
    var td = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("<td></td>");
    td.appendTo(tr);
    tr.appendTo(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#tbody'));
}
function createFood() {}
